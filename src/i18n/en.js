export default {
  ...
  account: {
    ...
    status:           'Status',
    subActive:        'Active — Ad Free',
    subInactive:      'Free Plan (Ads)',
    manageSubscription: 'Manage Subscription',
    cancelSubTitle:   'Manage Subscription',
    cancelSubMsg:     'To cancel, open your Apple ID subscription settings.',
    manageInApple:    'Open Apple Settings',
    goAdFree:         'Go Ad Free',
  ...
  subscription: {
    ...
    benefit2:     'Faster experience',
    benefit3:     'Support MotoDash',
    perMonth:     'month',
    subscribe:    'Subscribe Now',
    restore:      'Restore Purchases',
    legal:        'Subscription auto-renews monthly. Cancel any time in your Apple ID settings.',
    successTitle: 'You\'re subscribed!',
    successMsg:   'Ads have been removed. Thank you for supporting MotoDash.',
    restoredTitle:'Subscription restored!',
    restoredMsg:  'Your ad-free subscription is active again.',
    noRestoreTitle: 'No subscription found',
    noRestoreMsg:   'We couldn\'t find an active subscription on this account.',
    activeTitle:  'Subscription active',
    activeBody:   'You\'re enjoying an ad-free MotoDash. Your subscription renews monthly — you can cancel any time in your Apple ID settings.',
  },
